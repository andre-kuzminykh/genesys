...
const KEY = 'genesys:v0.10';
const LEGACY_KEYS = ['genesys:v0.9', 'genesys:v0.8', 'genesys:v0.7', 'genesys:v0.6', 'genesys:v0.5', 'genesys:v0.4', 'genesys:v0.3', 'genesys:v0.2', 'genesys:v0.1', 'genesis:v0.1'];
